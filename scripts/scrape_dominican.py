#!/usr/bin/env python3
"""
Dominican University course catalog scraper.
URL: dominican.smartcatalogiq.com/en/2025-2026/academic-catalog/courses/
...
BASE_URL = "https://dominican.smartcatalogiq.com"
...
STEM = {"biol", "chem", "csci", "math", "phys", "stat", "envs", "nurs", "data", "cs"}
...
PROFESSIONAL = {"acct", "buad", "fin", "mgmt", "mktg", "bus", "mba", "lis"}
...
def get_course_urls(session, dept_path):
    ...
    soup = BeautifulSoup(r.text, "html.parser")
    links = [a["href"] for a in soup.find_all("a", href=True)]
    # Dominican uses 4-digit level folders like /1000/, /2000/ etc.
...
def main():
    ...
    print(f"=== Dominican University Course Catalog Scraper ===")
