#!/usr/bin/env python3
"""
Trevecca Nazarene University course catalog scraper.
URL: trevecca.smartcatalogiq.com/en/2025-2026/{university-catalog|graduate-catalog}/courses/{dept}/{level}/{course}
...
BASE_URL = "https://trevecca.smartcatalogiq.com"
...
STEM = {"biol", "chem", "csci", "envs", "math", "nurs", "phys", "stat", "dat", "csc"}
HUMANITIES = {"art", "comm", "engl", "fren", "ger", "hist", "musi", "phil", "reli", "span",
              "thea", "wgst", "the", "bibl", "bib", "lang"}
SOCIAL = {"anth", "cjus", "econ", "educ", "pols", "psyc", "soci", "socw", "sw",
          "psy", "pol"}
MEDICAL = {"hlth", "kine", "nurs", "nutr", "alh", "ath"}
PROFESSIONAL = {"acct", "badm", "fin", "mgmt", "mktg", "bus", "act"}
...
def main():
    ...
    print(f"=== Trevecca Nazarene University Course Catalog Scraper ===")
    print(f"Catalog year: {CATALOG_LABEL}")

    catalog_sections = [
        ("/en/2025-2026/university-catalog", "undergraduate"),
        ("/en/2025-2026/graduate-catalog", "graduate"),
    ]

    all_course_items = []
    for catalog_path, section in catalog_sections:
