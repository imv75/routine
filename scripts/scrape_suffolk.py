#!/usr/bin/env python3
"""
Suffolk University course catalog scraper.
URL: suffolk.smartcatalogiq.com/en/current/catalog/courses/{dept}/{level}/{course}
...
BASE_URL = "https://suffolk.smartcatalogiq.com"
...
SOCIAL = {"anth", "cjus", "econ", "educ", "pols", "psyc", "soci", "socw", "gov",
          "psy", "soc"}
MEDICAL = {"hlth", "kine", "nurs", "nutr", "athl"}
PROFESSIONAL = {"acct", "buad", "fin", "mgmt", "mktg", "bus", "mba", "law"}
...
def main():
    ...
    print(f"=== Suffolk University Course Catalog Scraper ===")
