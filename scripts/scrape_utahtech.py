#!/usr/bin/env python3
"""
Utah Tech University course catalog scraper.
URL: catalog.utahtech.edu/courses/{dept}/
HTML: div.courseblock > p.courseblocktitle > strong "ACCT 2010.  Principles of Accounting I.  3 Hours."
      + p.courseblockdesc
"""
...
BASE_URL = "https://catalog.utahtech.edu"
...
def main():
    ...
    print(f"=== Utah Tech University Course Catalog Scraper ===")
