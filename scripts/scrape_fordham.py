#!/usr/bin/env python3
"""
Fordham University course catalog scraper.
URL: bulletin.fordham.edu/courses/{dept}/
HTML: p.courseblocktitle.noindent > strong "DEPT NUM.  Title.  (N Credits)"
...
BASE_URL = "https://bulletin.fordham.edu"
...
STEM = {"biol", "chem", "cs", "csci", "cisc", "math", "phys", "stat", "envs", "enph",
        "civi", "elec", "mech", "meen", "meen"}
HUMANITIES = {"afam", "amcs", "amst", "arth", "chin", "clas", "clmt", "comm", "complit",
              "engl", "fren", "germ", "grek", "hist", "ital", "jpns", "lat", "ling",
              "medi", "musi", "phil", "port", "russ", "span", "thea", "wgss"}
SOCIAL = {"anth", "comu", "econ", "educ", "govt", "pols", "psyc", "soci", "socw", "sw",
          "intl", "glbl"}
MEDICAL = {"biol", "hlth", "nurs", "nutr"}
PROFESSIONAL = {"acct", "acbu", "acgl", "acgb", "adgl", "fina", "law", "mgmt", "mktg",
                "mgbu", "mggl"}
...
def main():
    ...
    print(f"=== Fordham University Course Catalog Scraper ===")
