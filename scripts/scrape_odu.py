...
HTML: div.courseblock > div.cols.noindent "ACCT 201  Principles of Financial Accounting  (3 Credit Hours)"
...
STEM = {"biol", "chem", "cs", "cee", "ece", "envs", "geol", "math", "mae", "mse",
        "oces", "phys", "stat"}
HUMANITIES = {"aast", "amst", "arab", "arte", "arth", "chin", "engl", "fren",
              "germ", "grek", "hist", "ital", "japn", "lat", "ling", "musi",
              "phil", "port", "russ", "span", "thea", "wmst"}
SOCIAL = {"aast", "antr", "comm", "crim", "econ", "educ", "geog", "pols",
          "psyc", "soci", "socw", "wgss"}
MEDICAL = {"biol", "dent", "hlth", "kine", "nurs", "nutr", "pt"}
PROFESSIONAL = {"acct", "ba", "fin", "mba", "mgmt", "mkt", "hmgt", "law"}
...
def parse_dept_page(html_text):
    ...
    for block in soup.find_all("div", class_="courseblock"):
        # First div.cols or div with course code/title
        ...
        # Strip trailing credit hours if still there
        title = re.sub(r"\s+\(\d+\s+Credit.*$", "", title, flags=re.IGNORECASE).strip()

        # Description: first div.noindent that is NOT the header
        desc = ""
