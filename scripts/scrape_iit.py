#!/usr/bin/env python3
"""
Illinois Institute of Technology course catalog scraper.
URL: catalog.iit.edu/courses/{dept}/
HTML: div.courseblock > div.courseblocktitle "DEPT NUM Title"
      + div.courseblockdesc
"""
...
STEM = {"biol", "bme", "che", "chem", "cs", "ds", "ece", "eg", "enve", "math",
        "mmae", "ns", "phys", "sci", "stat"}
HUMANITIES = {"aah", "hist", "hum", "la", "lit", "phil"}
SOCIAL = {"com", "econ", "pol", "psyc", "soc", "ssci"}
PROFESSIONAL = {"bus", "emgt", "intm", "itm", "law", "mba", "msf"}
...
def main():
    ...
    print(f"=== Illinois Institute of Technology Course Catalog Scraper ===")
