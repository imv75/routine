#!/usr/bin/env python3
"""
University of Wisconsin-Eau Claire course catalog scraper.
URL: catalog.uwec.edu/courses/{dept}/
HTML: div.courseblock > p.courseblocktitle > strong "ACCT 201 Introduction to Accounting (3 crs)"
      + p.courseblockdescription
"""
...
BASE_URL = "https://catalog.uwec.edu"
...
STEM = {"biol", "chem", "cs", "csci", "ce", "ee", "envs", "geol", "math", "phys", "stat"}
HUMANITIES = {"art", "arth", "chin", "comm", "engl", "fren", "germ", "hist",
              "jpns", "ling", "musi", "phil", "span", "thea", "wgst"}
...
def parse_dept_page(html_text):
    ...
    for block in soup.find_all("div", class_="courseblock"):
        ...
        # Description is in p.courseblockdescription (not .courseblockdesc)
        desc_p = block.find("p", class_="courseblockdescription")
...
def main():
    ...
    print(f"=== University of Wisconsin-Eau Claire Course Catalog Scraper ===")
