#!/usr/bin/env python3
"""
Simmons University course catalog scraper.
UG: simmons.smartcatalogiq.com/en/2024-2025/undergraduate-course-catalog/undergraduate-courses/
Grad: simmons.smartcatalogiq.com/en/2024-2025/graduate-course-catalog/graduate-courses/
...
BASE_URL = "https://simmons.smartcatalogiq.com"
...
SECTIONS = [
    ("/en/2024-2025/undergraduate-course-catalog", "undergraduate-courses", "undergraduate"),
    ("/en/2024-2025/graduate-course-catalog", "graduate-courses", "graduate"),
]
...
MEDICAL = {"hlth", "kine", "nurs", "nutr", "athl", "ot", "pt"}
PROFESSIONAL = {"acct", "buad", "fin", "mgmt", "mktg", "bus", "mba", "lis", "lsc"}
...
def main():
    ...
    print(f"=== Simmons University Course Catalog Scraper ===")
