#!/usr/bin/env python3
"""
Coker University course catalog scraper.
URL: coker.smartcatalogiq.com/en/2025-2026/academic-catalog/courses/{dept}/{level}/{course}
...
BASE_URL = "https://coker.smartcatalogiq.com"
CATALOG_PATH = "/en/2025-2026/academic-catalog"
...
STEM = {"bio", "che", "cs", "cte", "cyb", "dat", "egr", "math", "phy", "stat"}
HUMANITIES = {"aas", "art", "chi", "com", "dnc", "eng", "fre", "ger", "gre", "his",
              "lat", "mus", "phi", "rel", "spa", "the", "thea", "wgst"}
SOCIAL = {"crim", "edu", "psy", "pol", "soc", "socw", "sw"}
MEDICAL = {"hlth", "kine", "nurs", "nutr", "ath"}
PROFESSIONAL = {"bus", "fin", "mgmt", "mkt", "acc"}
...
def main():
    ...
    print(f"=== Coker University Course Catalog Scraper ===")
