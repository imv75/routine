#!/usr/bin/env python3
"""
Centre College course catalog scraper.
URL: centre.smartcatalogiq.com/en/2025-2026/catalog/course-descriptions/{dept}/{level}/{course}
...
BASE_URL = "https://centre.smartcatalogiq.com"
...
STEM = {"bio", "chm", "csc", "envs", "math", "phys", "stat", "nsc", "biochem"}
HUMANITIES = {"aas", "aes", "ams", "arb", "asl", "arh", "ars", "asn", "cla", "com",
              "eng", "fre", "ger", "gre", "his", "hum", "jpn", "lat", "mst", "mus",
              "phi", "rel", "spa", "the"}
SOCIAL = {"ant", "eco", "edu", "pol", "psy", "soc", "socw", "cjs"}
MEDICAL = {"hlh", "kin", "nrs", "nutr"}
PROFESSIONAL = {"acc", "bus", "fin", "mgt", "mkt"}
...
def main():
    ...
    print(f"=== Centre College Course Catalog Scraper ===")
