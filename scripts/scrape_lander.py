#!/usr/bin/env python3
"""
Lander University course catalog scraper.
URL: lander.smartcatalogiq.com/en/current/{undergraduate|graduate}-catalog/courses/{dept}/{level}/{course}
...
BASE_URL = "https://lander.smartcatalogiq.com"
...
STEM = {"aai", "biol", "chem", "csci", "envs", "math", "nurs", "phys", "stat", "cs", "data"}
HUMANITIES = {"art", "engl", "fren", "ger", "hist", "musi", "phil", "reli", "span", "thea",
              "wgst", "comm", "blst"}
SOCIAL = {"anth", "cjus", "econ", "educ", "pols", "psyc", "soci", "socw", "psy", "pol"}
MEDICAL = {"hlth", "kine", "nurs", "nutr", "ath", "exsc"}
...
def main():
    ...
    print(f"=== Lander University Course Catalog Scraper ===")
