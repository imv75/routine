#!/usr/bin/env python3
"""
Vanguard University course catalog scraper.
URL: catalog.vanguard.edu/courses/{dept}/
HTML: div.cols.noindent > span.detail-code "ACCT-P225" + span.detail-title "Title"
...
BASE_URL = "https://catalog.vanguard.edu"
...
STEM = {"biol", "chem", "cs", "math", "phys", "stat", "env"}
HUMANITIES = {"art", "engl", "hist", "musi", "phil", "span", "thea"}
SOCIAL = {"anth", "comm", "econ", "educ", "pols", "psyc", "soci", "sw"}
MEDICAL = {"hlth", "kine", "nurs", "nutr"}
PROFESSIONAL = {"acct", "bint", "fin", "mgmt", "mktg"}
...
def main():
    ...
    print(f"=== Vanguard University Course Catalog Scraper ===")
